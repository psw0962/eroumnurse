...
const SERVICES = [
  {
    icon: "💉",
    title: "전문 간호 서비스",
    desc: "욕창, 상처 드레싱, 콧줄, 소변줄 관리 등 가정에서 필요한 전문 간호 처치를 면허 간호사가 직접 제공합니다.",
  },
  {
    icon: "💊",
    title: "투약 관리",
  ...
  },
  {
    icon: "🧠",
    title: "인지기능 관리",
    desc: "치매·인지 저하 어르신을 위한 전문적인 인지 자극 프로그램을 간호사가 직접 설계·운영합니다.",
  },
  {
    icon: "🏥",
    title: "1:1 맞춤 방문재활",
  ...
  },
  {
    icon: "👨‍👩‍👧",
    title: "가족 교육 및 상담",
    desc: "보호자가 가정에서 올바른 돌봄을 실천할 수 있도록 간호사가 직접 교육하고 상담합니다.",
  },
];
...
const WHY_US = [
  {
    icon: "👩‍⚕️",
    title: "100% 면허 간호사 운영",
    desc: "요양보호사가 아닌 국가면허 간호사가 직접 방문합니다.",
  },
  {
    icon: "📋",
    title: "개인 맞춤 간호 계획",
...
const STEPS = [
  ...
  },
  {
    num: "02",
    title: "간호사 방문 상담",
    desc: "면허 간호사가 직접 방문하여 어르신 건강 상태를 전문적으로 평가합니다.",
  },
  {
    num: "03",
    title: "장기요양 등급 신청",
