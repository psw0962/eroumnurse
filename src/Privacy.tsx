    ...
    <div className='flex flex-col gap-4 p-3'>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <pre className='text-sm break-keep whitespace-pre-wrap'>
          {`이로움방문간호센터(이하 "센터")는 수집한 개인정보를 다음의 목적을 위해 활용합니다.
- 회원 관리
- 서비스 제공`}
        </pre>
      </div>
...
보존 기간: 3개월`}
      ...
      <div className='flex flex-col gap-2'>
        ...
        <pre className='text-sm break-keep whitespace-pre-wrap'>
          {`이로움방문간호센터는 회원가입, 서비스 이용 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
...
탈퇴처리가 진행되면 DB에 있는 계정정보와, 해당 계정으로 작성된 모든 게시글과 댓글이 삭제됩니다.`}
      ...
      <div className='flex flex-col gap-2'>
        ...
        <pre className='text-sm break-keep whitespace-pre-wrap'>
          {`이로움방문간호센터는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.
...
3) 취급 직원의 최소화 및 교육`}</pre>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <pre className='text-sm break-keep whitespace-pre-wrap'>{`성명: 박제인
이메일: janeee3299@gmail.com
...
`}</pre>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <pre className='text-sm break-keep whitespace-pre-wrap'>{`이 개인정보 취급방침은 2026년 1월 1일부터 적용됩니다.
